...
export default function Home() {
  ...
  return (
    <main className="relative h-dvh w-full overflow-hidden bg-background">
      ...
      <header className={cn(
        "absolute top-0 left-0 right-0 z-20 flex justify-center px-4 pt-12 md:px-8 md:pt-3 transition-transform duration-500 ease-in-out",
      ...
      <footer className={cn(
        "absolute bottom-0 left-0 right-0 z-20 flex justify-center px-4 pb-14 md:px-8 md:pt-8 md:pb-[4%] transition-transform duration-500 ease-in-out",
        isMobile && isInteracted && "-translate-y-8"
      )}>
